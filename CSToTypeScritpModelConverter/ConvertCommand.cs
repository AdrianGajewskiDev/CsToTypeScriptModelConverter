...
namespace CSToTypeScritpModelConverter
{
    ...
    internal sealed class TestCommand
    {
        ...
        {
            VsShellUtilities.ShowMessageBox(this.package, "Convert","Convert Msg",OLEMSGICON.OLEMSGICON_INFO, OLEMSGBUTTON.OLEMSGBUTTON_OK, OLEMSGDEFBUTTON.OLEMSGDEFBUTTON_FIRST);
        }
    }
}
